...
namespace reactiv\customtopicfields\customfields\type;

class type_bool extends type_base
{
	/**
	* Profile fields language helper
	* @var \reactiv\customtopicfields\customfields\lang_helper
	*/
	...
	* Construct
	*
	* @param	\reactiv\customtopicfields\customfields\lang_helper		$lang_helper	Profile fields language helper
	* @param	\phpbb\request\request		$request	Request object
	* @param	\phpbb\template\template	$template	Template object
	* @param	\phpbb\user					$user		User object
	*/
	public function __construct(\reactiv\customtopicfields\customfields\lang_helper $lang_helper, \phpbb\request\request $request, \phpbb\template\template $template, \phpbb\user $user)
	{
